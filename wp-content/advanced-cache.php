...
if ( version_compare( phpversion(), '5.4' ) >= 0 ) {
	...
	spl_autoload_register(
		function( $class ) {
			$rocket_path    = '/home/customer/www/thecorner.es/public_html/wp-content/plugins/wp-rocket/';
			$rocket_classes = [
	...
	$rocket_config_class = new \WP_Rocket\Buffer\Config(
		[
			'config_dir_path' => '/home/customer/www/thecorner.es/public_html/wp-content/wp-rocket-config/',
		]
	);
	...
	( new \WP_Rocket\Buffer\Cache(
		...
		$rocket_config_class,
		[
			'cache_dir_path' => '/home/customer/www/thecorner.es/public_html/wp-content/cache/wp-rocket/',
		]
	) )->maybe_init_process();;
} else {
